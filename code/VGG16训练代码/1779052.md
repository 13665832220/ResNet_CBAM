...
with open('data/data89551/train_list.txt','r') as f:
...
train_parameters = {
    ...
    "class_dim": 6,  # 分类数，会在初始化自定义 reader 的时候获得
    "image_count": -1,  # 训练图片数量，会在初始化自定义 reader 的时候获得
    "label_dict": {},
    "data_dir": "data/data89551",  # 训练数据存储地址   
...
def train():
    ...
    for pass_id in range(train_parameters["num_epochs"]):
        ...
        for batch_id, data in enumerate(train_reader()):
            ...
            #     resultFile.write(str(all_train_iter) + "\t" + str(train_cost[0]) + "\t" + str(train_acc[0]))
            #     resultFile.write("\n")
